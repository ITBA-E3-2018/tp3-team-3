...
\graphicspath{{Ej1/Informe/figures/}{Ej1/Informe/}{Ej1/}
		  {Ej2/Informe/figures/}{Ej2/Informe/}{Ej2/}
		  {Ej3/Informe/figures/}{Ej3/Informe/}{Ej3/}
		  {Ej4/Informe/figures/}{Ej4/Informe/}{Ej4/}
		  {Ej5/Informe/figures/}{Ej5/Informe/}{Ej5/}}
...
\usepackage{tikzit/tikzit}						%gui para graficos en tikz
...
\AtBeginDocument{\renewcommand\contentsname{Index}}
\AtBeginDocument{\renewcommand\figurename{Figure}}
\AtBeginDocument{\renewcommand\tablename{Table}}
\AtBeginDocument{\renewcommand\chaptername{Exercise}}

\definecolor{mygreen}{RGB}{28,172,0} % color values Red, Green, Blue
\definecolor{mylilas}{RGB}{170,55,241}


\input{tikzit/fsm.tikzstyles}		%lo use para e3 tp3, si molesta borrar
